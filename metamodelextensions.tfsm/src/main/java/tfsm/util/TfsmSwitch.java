...
public class TfsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TfsmPackage.FSM: {
				...
				if (result == null) result = caseFsm_FSM(fsm);
			...
			case TfsmPackage.STATE: {
				...
				if (result == null) result = caseFsm_State(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TfsmPackage.TRANSITION: {
				...
				if (result == null) result = caseFsm_Transition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseFsm_FSM(fsm.FSM object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseFsm_State(fsm.State object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseFsm_Transition(fsm.Transition object) {
		return null;
	}
