...
public class TfsmAdapterFactory extends AdapterFactoryImpl {
	...
	protected TfsmSwitch<Adapter> modelSwitch =
		new TfsmSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFsm_FSM(fsm.FSM object) {
				return createFsm_FSMAdapter();
			}
			@Override
			public Adapter caseFsm_State(fsm.State object) {
				return createFsm_StateAdapter();
			}
			@Override
			public Adapter caseFsm_Transition(fsm.Transition object) {
				return createFsm_TransitionAdapter();
			}
			@Override
	 ...
	 * @generated
	 */
	public Adapter createFsm_FSMAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createFsm_StateAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createFsm_TransitionAdapter() {
		return null;
	}
