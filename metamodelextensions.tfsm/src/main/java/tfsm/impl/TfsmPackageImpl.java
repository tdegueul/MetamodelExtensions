...
public class TfsmPackageImpl extends EPackageImpl implements TfsmPackage {
	 ...
	 * @generated
	 */
	public EAttribute getGuard_Time() {
	...
	public void createPackageContents() {
		...
		createEAttribute(guardEClass, GUARD__TIME);
	}
	...
	public void initializePackageContents() {
		...
		fsmEClass.getESuperTypes().add(theFsmPackage.getFSM());
		stateEClass.getESuperTypes().add(theFsmPackage.getState());
		transitionEClass.getESuperTypes().add(theFsmPackage.getTransition());
		...
		initEAttribute(getState_Time(), ecorePackage.getEInt(), "time", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGuard_Time(), ecorePackage.getEInt(), "time", null, 0, 1, Guard.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
