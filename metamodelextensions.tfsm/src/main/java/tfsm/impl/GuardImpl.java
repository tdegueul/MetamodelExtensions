 ...
 * <ul>
 *   <li>{@link tfsm.impl.GuardImpl#getTime <em>Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GuardImpl extends MinimalEObjectImpl.Container implements Guard {
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.GUARD__TIME, oldTime, time));
	}
